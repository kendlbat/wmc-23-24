        ...
        <div className="wmc4-app">
            <div className="row bg-dark text-white head-row align-items-center">
                ...
                <div className="col p-3 text-end">
                    <ColumnVisibilityControl columnsToShow={columnsToShow} onColumnVisiblityChange={changeColumnToShow}></ColumnVisibilityControl>
                </div>
            </div>
          ...
          <div className="col-2 col-scrollable border-end">
              <div className="p-3">
                  <h2>School</h2>
                  {SCHOOLS_TASKS.map(task => <div key={task.key} className="mb-2"><TaskCard task={task} onClick={openTask}></TaskCard></div>)}
              </div>
          </div>}
          ...
          <div className="col-2 col-scrollable border-end">
              <div className="p-3">
                  <h2>Home</h2>
                  {HOME_TASKS.map(task => <div key={task.key} className="mb-2"><TaskCard task={task} onClick={openTask}></TaskCard></div>)}
              </div>
          </div>
                }
          ...
          <div className="col col-scrollable border-end">
              <div className="p-3">
                  {currentTask.key && <div>
                      <h2>{currentTask.title} ({currentTask.key})</h2>
