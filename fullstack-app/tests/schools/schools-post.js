...
describe("Schools - POST", () => {
    ...
    describe("/POST schools - error flows", () => {
        it("it should not add a school with invalid category", async () => {
            let invalidSchool = { ...validSchool, category: "XHS" };
        ...
        it("it should not add a school with invalid code", async () => {
            let invalidSchool = { ...validSchool, code: 4711 };
